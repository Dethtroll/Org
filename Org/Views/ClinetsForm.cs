...
namespace Org.Views
{
    public partial class ClinetsForm : Form, ICompaniesView
    {
        ...
        public ClinetsForm(OrgContext context, IUpdateService updateService)
        {
            InitializeComponent();

            new ClientFormPresenter(this, new ClientRepository(context, updateService));
        }
