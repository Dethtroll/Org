...
namespace Org.Views
{
    public partial class ManufactorsForm : Form, IDictionayView
    {
        ...
        public ManufactorsForm(OrgContext context, IUpdateService updateService)
        {
            InitializeComponent();

            new ManufactorPresenter(this, new ManufactorRepository(context, updateService));
        }
